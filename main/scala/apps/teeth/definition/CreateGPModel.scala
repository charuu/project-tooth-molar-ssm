...
object CreateGPModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    Seq(50000).foreach { i =>
      ...
      val outputModelFile = new File(generalPath, s"tooth_gp_model_$i-components.h5")
      ...
      val cov: MatrixValuedPDKernel[_3D] = new MatrixValuedPDKernel[_3D]() {
        private val kernels = DiagonalKernel[_3D](GaussianKernel(8), 3) * 1.0
      ...
      val lowRankGP = LowRankGaussianProcess.approximateGPNystrom(gp, sampler, numBasisFunctions = 200)
